...
class Simulator:
    ...
    def __init__(self, module_directory: str, index: str,setup_function: str, my_simulation_parameters: SimulationParameters): # Add a new parameter , index
        ...
        directoryname = "{}_{}_{}".format(index,setup_function.lower(), datetime.datetime.now().strftime("%Y%m%d_%H%M%S"))
        self.dirpath = os.path.join(module_directory, "results", directoryname)
        self.resultsdir = os.path.join(module_directory,"results") # Add a new parameter , index
