...
from components.chp_system import CHP
...
def basic_household(my_sim,capacity=capacitiy,power=power):
    ...
    csv_load_power_demand = CSVLoaderEL(component_name="csv_load_power",
                                      csv_filename="loadprofiles/vdi-4655/vdi-4655_mfh-existing_try-1_15min.csv",
                                      column=1,
    ...
    my_controller.connect_input(my_controller.ElectricityToElectrolyzerUnused,
