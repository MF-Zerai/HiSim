...
def main(path_to_module: str, index:str ,function_in_module: str, my_simulation_parameters = None): # add a new parameter, index
    log.information("#################################")
...
if __name__ == "__main__":
    ...
    for i in ['_1','_2','_3','_4','_5']:
        main(path_to_module=filename, index=i, function_in_module=functionname+i)
