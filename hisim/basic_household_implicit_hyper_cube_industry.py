...
if __name__ == '__main__':
    ...
    while z <= lhs_field.shape[1]:
        ...
        lhs_factor_weather_region=int(lhs_field[3,x]//(1/15)+1)   #either exact [0,1,2,3...13,14]
        lhs_factor_control_strategy=int(lhs_field[4,x]//(1/2)) #either[0,1,]
        lhs_factor_percentage_to_peak_shave=int(lhs_field[5,x]//(1/3))
        ...
        max_electricity_demand=int(column_electricity_demand)
        sum_anual_electrcitcy_demand=int(sum(column_electricity_demand))
        limit_peak_shave=max_electricity_demand*percentage_to_peak_shave_var
