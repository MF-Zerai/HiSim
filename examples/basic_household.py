...
def carbon_data_scotland ():
    headers = {'Accept': 'application/json'} 
    r = requests.get("https://api.carbonintensity.org.uk/regional/regionid/2", params={}, headers = headers)
    return r.json()

# configuration = {
#     {
#         'building_code':'GB.ENG.MFH.05.Gen.ReEx.001.002',
#         'initial_temperature':22,
#         't_air_heating':21,
#         't_air_cooling':15,
#     },
#         {
#         'building_code':'GB.ENG.MFH.06.Gen.ReEx.001.002',
#         'initial_temperature':22,
#         't_air_heating':20,
#         't_air_cooling':17,
#     },
#         {
#         'building_code':'GB.ENG.MFH.08.Gen.ReEx.001.001',
#         'initial_temperature':23,
#         't_air_heating':22,
#         't_air_cooling':15,
#     },
#         {
#         'building_code':'GB.ENG.TH.02.Gen.ReEx.001.001',
#         'initial_temperature':22,
#         't_air_heating':21,
#         't_air_cooling':18,
#     },
#         {
#         'building_code':'GB.ENG.TH.06.Gen.ReEx.001.001',
#         'initial_temperature':23,
#         't_air_heating':19,
#         't_air_cooling':16,
#     }
...
def loop_household_explicit(my_sim, my_simulation_parameters: Optional[SimulationParameters] = None):
    """
    ...
    for i in configuration:
        ...
        initial_temperature = i['initial_temperature']

        # Set heat pump controller
        t_air_heating = i['t_air_heating']
        t_air_cooling = i['t_air_cooling']
        offset = 0.5
        hp_mode = 2
...
def basic_household_explicit(my_sim, my_simulation_parameters: Optional[SimulationParameters] = None):
    ...
    # Set building
    building_code = configuration[index]['building_code']
    building_class = "medium"
    initial_temperature = configuration[index]['initial_temperature']

    # Set heat pump controller
    t_air_heating = configuration[index]['t_air_heating']
    t_air_cooling = configuration[index]['t_air_cooling']
    offset = 0.5
    hp_mode = 2
...
def basic_household_explicit_1(my_sim, my_simulation_parameters: Optional[SimulationParameters] = None):
    """
    This setup function emulates an household including
    the basic components. Here the residents have their
    electricity and heating needs covered by the photovoltaic
...
def basic_household_explicit_2(my_sim, my_simulation_parameters: Optional[SimulationParameters] = None):
    """
    This setup function emulates an household including
    the basic components. Here the residents have their
    electricity and heating needs covered by the photovoltaic
...
def basic_household_explicit_3(my_sim, my_simulation_parameters: Optional[SimulationParameters] = None):
    """
    This setup function emulates an household including
    the basic components. Here the residents have their
    electricity and heating needs covered by the photovoltaic
...
def basic_household_explicit_4(my_sim, my_simulation_parameters: Optional[SimulationParameters] = None):
    """
    This setup function emulates an household including
    the basic components. Here the residents have their
    electricity and heating needs covered by the photovoltaic
...
def basic_household_explicit_5(my_sim, my_simulation_parameters: Optional[SimulationParameters] = None):
    """
    This setup function emulates an household including
    the basic components. Here the residents have their
    electricity and heating needs covered by the photovoltaic
